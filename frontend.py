...
class CountryCardWindow(tk.Toplevel):
    ...
    def __init__(self, master, selected_countries):
        ...
        for country in selected_countries:
            name, flag, official, caps, pop, area, langs, currens, continent, url = country
            ...
            # create tab to put into the window
            ...
            tk.Label(my_frame1, text = f'{cap_label}: ' + caps, font = ('Calibri', 13), fg = 'blue').grid()
            ...
            tk.Label(my_frame1, text = f'{lang_label}: ' + langs, font = ('Calibri', 13), fg = 'blue', wraplength = 300, justify = "center").grid()
            tk.Label(my_frame1, text = f'{currens_label}: ' + currens.title(), font = ('Calibri', 13), fg='blue').grid()
